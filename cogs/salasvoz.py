...
def config(dados, guild_id):
    ...
    return dados.setdefault(str(guild_id), {"canal_gatilho": None, "salas_criadas": {}})
...
class SalasVoz(commands.Cog):
    ...
    async def on_voice_state_update(self, member, before, after):
        ...
        # entrou no canal "gatilho" -> cria sala nova
        ...
        # saiu de um canal -> se for sala temporária vazia, apaga
...
class SelecionarCanalGatilho(ChannelSelect):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await interaction.response.edit_message(view=container_view(texto, self.view))
